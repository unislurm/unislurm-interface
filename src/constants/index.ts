...
export const USDF = new Token(ChainId.ROPSTEN, '0x2d057bfb90dcf36f224c39b7426895a3abae88f3', 18, 'USDF', 'USDF')
...
export const UNI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.RINKEBY]: new Token(ChainId.RINKEBY, UNI_ADDRESS, 18, 'UNIS', 'Unislurm'),
  [ChainId.ROPSTEN]: new Token(ChainId.ROPSTEN, UNI_ADDRESS, 18, 'UNIS', 'Unislurm'),
  [ChainId.GÖRLI]: new Token(ChainId.GÖRLI, UNI_ADDRESS, 18, 'UNIS', 'Unislurm'),
...
const WETH_ONLY: ChainTokenList = {
  ...
  [ChainId.TESTBNB]: [WETH[ChainId.TESTBNB]],
